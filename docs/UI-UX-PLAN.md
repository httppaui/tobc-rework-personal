...
- **2026-05-26 — Partners pagination:** Replaced “Load More Partners” with Courses-style page controls (first/prev/next/last + page count). Files: `PartnersPage.tsx`, `main.css`, `UI-UX-PLAN.md`.
